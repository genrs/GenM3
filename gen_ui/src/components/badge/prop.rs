...
impl SlotStyle for BadgeProp {
    ...
    fn sync_slot(&mut self, map: &crate::prop::ApplySlotMap<Self::State, Self::Part>) -> () {
        map.sync(
            ...
            BadgeState::Basic,
            [
                (BadgeState::Hover, &mut self.hover),
                (BadgeState::Pressed, &mut self.pressed),
...
impl Style for BadgeProp {
    ...
    get_get_mut! {
        ...
        BadgeState::Hover => hover,
        BadgeState::Pressed => pressed,
        BadgeState::Disabled => disabled
    }

    fn len() -> usize {
        4 * BadgeBasicStyle::len()
    }
...
pub struct BadgeBasicStyle {
    #[live(BadgeBasicStyle::default_icon(Theme::default(), BadgeState::default()))]
    pub icon: SvgBasicStyle,
    #[live(BadgeBasicStyle::default_text(Theme::default(), BadgeState::default()))]
    pub text: LabelBasicStyle,
    #[live(BadgeBasicStyle::default_close(Theme::default(), BadgeState::default()))]
...
impl BadgeBasicStyle {
    ...
    pub fn default_close(theme: Theme, state: BadgeState) -> SvgBasicStyle {
        SvgBasicStyle::from_state(theme, state.into())
    }

    pub fn default_icon(theme: Theme, state: BadgeState) -> SvgBasicStyle {
        SvgBasicStyle::from_state(theme, state.into())
    }
}
...
impl From<BadgeState> for ViewState {
    fn from(value: BadgeState) -> Self {
        match value {
            ...
            BadgeState::Hover => ViewState::Hover,
            BadgeState::Pressed => ViewState::Pressed,
            BadgeState::Disabled => ViewState::Disabled,
        }
    }
}

impl From<ViewState> for BadgeState {
    fn from(value: ViewState) -> Self {
        match value {
            ViewState::Basic => BadgeState::Basic,
            ViewState::Hover => BadgeState::Hover,
            ViewState::Pressed => BadgeState::Pressed,
            ViewState::Disabled => BadgeState::Disabled,
        }
    }
}

impl From<BadgeState> for SvgState {
    fn from(value: BadgeState) -> Self {
        match value {
            BadgeState::Basic => SvgState::Basic,
            BadgeState::Hover => SvgState::Hover,
            BadgeState::Pressed => SvgState::Pressed,
            BadgeState::Disabled => SvgState::Disabled,
        }
    }
}
...
impl From<BadgeState> for LabelState {
    fn from(value: BadgeState) -> Self {
        match value {
            BadgeState::Basic | BadgeState::Hover | BadgeState::Pressed => LabelState::Basic,
