...
//     pub sync: bool,
//     #[rust]
//     pub apply_state_map: ApplyStateMap<BadgeState>,
//     #[rust]
...
// impl_view_trait_widget_node!(GBadge, draw_badge);
...
//             let mixin = |cx: &mut Cx, param: BadgeItemClicked| {
//                 cx.widget_action(
//                     uid,
//                     &scope_path,
//                     BadgeEvent::Changed(BadgeChanged {
//                         meta: param.meta,
...
//             nodes,
//             index,
//             &BadgeBasicStyle::live_props(),
//             [live_id!(basic), live_id!(disabled)],
//             |_| {},
//             |prefix, component, applys| match prefix.to_string().as_str() {
//                 BASIC => {
//                     component.apply_state_map.insert(BadgeState::Basic, applys);
//                 }
//                 DISABLED => {
//                     component
//                         .apply_state_map
...
//         let style = self.style.get(self.state);
//         self.draw_badge.merge(&(*style).into());
//         if self.disabled {
...
//             self.lifecycle.next();
//             let basic_prop = self.style.get(BadgeState::Basic);
//             let disabled_prop = self.style.get(BadgeState::Disabled);
...
//                         panic!(
//                             "GBadge can only have one active GBadgeItem, but found multiple: {}",
//                             child.value
//                         );
//                     }
//                 } else {
//                     panic!("GBadge only allows GBadgeItem as child!");
//                 }
//             });
...
// impl GBadge {
//     event_option! {
//         changed: BadgeEvent::Changed => BadgeChanged
//     }
// }
