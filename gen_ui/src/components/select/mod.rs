...
use crate::{
    ...
    components::{
        ...
        SlotComponent, SlotStyle, Style, SvgBasicStyle, item::GSelectItem,
    },
    error::Error,
...
pub struct SelectOptionsGlobal {
    pub map: Rc<RefCell<ComponentMap<LivePtr, GSelectItem>>>,
}
...
impl WidgetNode for GSelect {
    ...
    fn redraw(&mut self, cx: &mut Cx) {
        ...
        if self.selected_item.visible {
            self.selected_item.redraw(cx);
        }
